    ...
    <>
      ...
      >
        <p className="text-base text-muted-foreground">
          Reely.live is a free online movie and TV show streaming website that
          allows users to watch content sourced from third parties. Reely.live
        ...
        <p className="text-base text-muted-foreground">
          Reely.live has no control over the content quality, availability,
          copyright, legality or validity of the third party material viewed via
          the site. Reely.live cannot be held responsible for any streaming
        ...
        <p className="text-base text-muted-foreground">
          The operators of Reely.live make no warranties or representations
          ...
          Reely.live, you agree that access is provided “as is” at your own
          risk.
        </p>
        <div className="text-base text-muted-foreground">
          <p>Copyright Infringement:</p>
          Reely.live respects the intellectual property rights of others. Users
          are prohibited from using Reely.live to engage in copyright
          infringement or the unauthorized distribution of copyrighted content.
          Reely.live will promptly remove or disable access to any infringing
          content upon receipt of proper notification from the copyright holder.
        </div>
        <div className="text-base text-muted-foreground">
          <p>No Endorsement:</p>
          <p>
            The content accessible through Reely.live does not constitute an
        ...
        <div className="text-base text-muted-foreground">
          ...
          <p>
            Reely.live does not knowingly collect or distribute content
            considered obscene or harmful to minors as defined by applicable
            law. However, Reely.live has no control over third party content and
            some material accessible through Reely.live may be inappropriate for
        ...
        <div className="text-base text-muted-foreground">
          <p>No Warranties:</p>
          <p>
            Reely.live provides access to third party content on an “as is”
        ...
        <div className="text-base text-muted-foreground">
          ...
          <p>
            In no event shall Reely.live be liable for any direct, indirect,
            ...
            hold harmless Reely.live and its operators from any claims arising
