      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {series.status && (
          <Badge
            variant="outline"
            className={cn(
              series.status === 'Returning Series' && 'border-green-500/50 text-green-400',
              (series.status === 'Ended' || series.status === 'Canceled') && 'border-red-500/50 text-red-400',
              series.status === 'In Production' && 'border-blue-500/50 text-blue-400',
            )}
          >
            {series.status}
          </Badge>
